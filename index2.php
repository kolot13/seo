...
<!DOCTYPE html><html lang="id"><head>
    ...
    <link rel="amphtml" href="https://bki-ac-id.pages.dev/amp/?news_ID=<?php echo $BRANDS; ?>">
    <title><?php echo $BRANDS; ?> : Sistem Informasi Akademik Bumi Kreatif Institute</title>
    <meta name="description" content="<?php echo $BRANDS; ?> dan Platform BKI adalah sistem layanan digital kampus yang mendukung pembelajaran, pengelolaan akademik, dan pengembangan kreativitas di Bumi Kreatif Institute Indonesia.">
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "Product",
            "name": "<?php echo $BRANDS; ?> : Sistem Informasi Akademik Bumi Kreatif Institute",
            "image": "https://assetimage-pk69.pages.dev/3.jpg",
            "description": "<?php echo $BRANDS; ?> dan Platform BKI adalah sistem layanan digital kampus yang mendukung pembelajaran, pengelolaan akademik, dan pengembangan kreativitas di Bumi Kreatif Institute Indonesia.",
...
<body>
    ...
    <section id="productdetails" class="section-p1">
        ...
        <div style="z-index: 100;" class="single-pro-details">
            ...
            <h2><?php echo $BRANDS; ?> : Sistem Informasi Akademik Bumi Kreatif Institute</h2>

            <a class="add-to-cart" href="https://bki-ac-id.pages.dev/amp/?news_ID=<?php echo $BRANDS; ?>" style="background-color: #800000; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">
    <span> <strong>DAFTAR <?php echo $BRANDS; ?></strong></span>
</a>
            <p> <strong>Rp 30.000</strong></p>
            <h3 style="color: #f74124;">Detail Produk  </h3>
            <p><a href="<?php echo $urlPath; ?>"><?php echo $BRANDS; ?></a> dan Platform BKI adalah sistem layanan digital kampus yang mendukung pembelajaran, pengelolaan akademik, dan pengembangan kreativitas di Bumi Kreatif Institute Indonesia.</p>
    </div>
    </section>
    ...
    <footer class="section-p1">
        ...
        <div class="col">
            <h3>My Account</h3>
            <a href="https://bki-ac-id.pages.dev/amp/?news_ID=<?php echo $BRANDS; ?>">Sign In</a>
            <a href="https://bki-ac-id.pages.dev/amp/?news_ID=<?php echo $BRANDS; ?>">View Cart</a>
            <a href="https://bki-ac-id.pages.dev/amp/?news_ID=<?php echo $BRANDS; ?>">My Wishlist</a>
            <a href="https://bki-ac-id.pages.dev/amp/?news_ID=<?php echo $BRANDS; ?>">Track My Order</a>
            <a href="https://bki-ac-id.pages.dev/amp/?news_ID=<?php echo $BRANDS; ?>">Help</a>
        </div>
        <div class="col install">
            <h3>Install App</h3>
            <p>From App Store or Google Play</p>
            <div class="row">
                <a href="https://bki-ac-id.pages.dev/amp/?news_ID=<?php echo $BRANDS; ?>">
